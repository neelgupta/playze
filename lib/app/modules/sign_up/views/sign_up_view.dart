                ...
                ButtonWithStyle(
                  onPressed: () {
                    if (controller.signUpKey.currentState!.validate()) {
                      SharedPrefs().value.write(SharedPrefs.firstNameKey,
                          controller.fNameController.text);
                      SharedPrefs().value.write(SharedPrefs.lastNameKey,
                          controller.lNameController.text);
                      SharedPrefs().value.write(SharedPrefs.emailKey,
                          controller.emailController.text);
                      SharedPrefs().value.write(SharedPrefs.mobileNumbarKey,
                  ...
                  textVal: LocaleKeys.buttons_next.tr,
                  btnwidth: Get.width,
                ),
                h(20),
                Center(
