              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Text(
                                            LocaleKeys
                                                .labels_Children_information.tr,
                                      ...
                                      h(20),
                                      Text(
                                        LocaleKeys.text_Create_Account_nots.tr,
                                        style: AppTextStyle.size18Medium
                      ...
                      Text(
                        "Interest ",
                        style: AppTextStyle.size18Medium.copyWith(fontSize: 16),
                      ),
                      h(20),
                      GridView.builder(
                        shrinkWrap: true,
                            ...
                            return GestureDetector(
                                onTap: () {
                                  ...
                                  if (control.interestsList[index].isSelected ==
                                    ...
                                    log("controller.selectedInterestIdList :: ${controller.selectedInterestIdList}");
                                  } else if (control
                      ...
                      ButtonWithStyle(
                        onPressed: () {
                          for (var namecon in controller.nameControllersList) {
                          ...
                          if (controller.isChildDataValid.value) {
                            ...
                            } else if (controller.ageControllersList.isEmpty) {
                              controller.cagestatus.value = true;
                              // controller.status = "please enter Childrenage";
                            } else {
                              controller.signUpApiMethod(context);
                            }
                          }
                        },
                        textVal: LocaleKeys.buttons_sign_up.tr,
                        btnwidth: Get.width,
                      ),
                      h(10),
                      Center(
