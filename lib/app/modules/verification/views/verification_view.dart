        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              h(10),
              Text("An OTP has been sent to your registered mobile number 613-555-0139",style: AppTextStyle.size14Medium.copyWith(letterSpacing: 1,fontWeight: FontWeight.w600)),
              h(20),
              ...
              ButtonWithStyle(
                onPressed: () {
                  Get.toNamed(Routes.ADD_PROFILE_PICTURE);
                },
